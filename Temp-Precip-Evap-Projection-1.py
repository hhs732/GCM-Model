...
Eobs = Input[5:17 ,5]
Tlastv = Tobs[-1]
STobs = Tobs[0:11] #a = a[:index] + a[index+1 :] 
TPrev = np.append(Tlastv , STobs)
#print(TPrev)
#%%
...
ERawm = np.power((CE + XCEUHX * EUHXmonth[p] + XCITC * ITCmonth[p] + XCFcnJet * FcnJetm + XCFcnEUHX * FcnEUHXm + XCFcnITC * FcnITCm + XCFcnNPHX * FcnNPHXm),3)
