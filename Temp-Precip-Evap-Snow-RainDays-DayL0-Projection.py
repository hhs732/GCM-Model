...
XCPrecRD = Const[39,1]	
XCJetRD = Const[40,1]	
XCFcnJetRD = Const[41,1]	
XCITCRD = Const[42,1]	
XCFcnITCRD = Const[43,1]	
WidFcnJetRD = Const[44,1]	
LatFcnJetRD = Const[45,1]	
WidFcnITC = Const[46,1]	
LatFcnITC = Const[47,1]

WidFcnJetD0 = Const[50,1]
LatFcnJetD0 = Const[51,1]
WidFcnTPD0 = Const[52,1]
LatFcnTPD0 = Const[53,1]
CD0 =	Const[54,1]
XCJetD0 = Const[55,1]
XCTPD0 = Const[56,1]
XCFcnJetD0 = Const[57,1]
XCFcnTPD0 = Const[58,1]
#print(XCTPD0)
# ************************** Input Variables ******************************** #
Tobs = Input[5:17, 4]
NHTmonth = Mod4[4, 2:] 
...
#print (HRainDay)
#%%
# ************ Number of Days with Temp lower than 0C Projection *************#
...
TempMonth = TempSheet.write(0,0, "100PY/Month")
NumFormat = xlwt.easyxf(num_format_str='0.00')
for p in range (len(HTemp.T)):     
    for q in range (len(HTemp)):
        TempXL = TempSheet.write(q+1, p+1, HTemp[q,p], NumFormat) 
for p in range (len(HTemp.T)):     
    TempRowMonth = TempSheet.write(0, p+1, Month[p])
for q in range (len(HTemp)):
    PYear = -100*q
    TempColPYear = TempSheet.write(q+1, 0, PYear)
Output.save("Output.xls")
